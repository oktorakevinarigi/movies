            ...
            <div className="items-center gap-8 h-20 flex lg:ml-[250px] overflow-x-auto">
              <div className="flex items-center">
                ...
                <div className="uppercase text-xs min-w-[80px]">
                  <p className="text-white text-opacity-50 font-medium">User Score</p>
              ...
              <Divider />
              <div className="uppercase text-xs">
                <p className="text-white text-opacity-50 font-medium">language</p>
              ...
              {getMovieDetail.data?.production_companies.length ? (
                <>
                  <Divider />
                  <div className="uppercase text-xs">
                    <p className="text-white text-opacity-50 font-medium">production</p>
